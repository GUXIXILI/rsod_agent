...
function renderLineChart(data) {
  ...
  lineChartInstance.setOption({
    ...
    series: [{
      ...
      areaStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: 'rgba(74, 144, 217, 0.3)' }, { offset: 1, color: 'rgba(74, 144, 217, 0.02)' }]) },
      markLine: { silent: true, data: [{ type: 'average', name: '平均值' }], lineStyle: { color: '#F0A030', type: 'dashed' } }
    }]
  })
}
...
function renderBarChart(data) {
  ...
  barChartInstance.setOption({
    ...
    series: [{
      ...
      data: values,
      barWidth: '40%',
      itemStyle: { color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{ offset: 0, color: '#4A90D9' }, { offset: 1, color: '#87CEEB' }]), borderRadius: [4, 4, 0, 0] },
...
.stat-total .stat-card__icon { background: rgba(74, 144, 217, 0.12); color: #4A90D9; }
.stat-fire .stat-card__icon { background: rgba(126, 200, 80, 0.12); color: #7EC850; }
.stat-smoke .stat-card__icon { background: rgba(127, 140, 141, 0.12); color: #7F8C8D; }
.stat-warning .stat-card__icon { background: rgba(240, 160, 48, 0.12); color: #F0A030; }
.stat-card__content { flex: 1; min-width: 0; }
.stat-card__value { font-size: 28px; font-weight: 700; line-height: 1.2; color: #2C3E50; }
.stat-card__title { font-size: 13px; color: #7F8C8D; margin-top: 4px; }
.stat-total .stat-card__value { color: #4A90D9; }
.stat-fire .stat-card__value { color: #7EC850; }
.stat-smoke .stat-card__value { color: #7F8C8D; }
.stat-warning .stat-card__value { color: #F0A030; }

.stat-card__growth { margin-top: 6px; font-size: 13px; display: flex; align-items: center; gap: 6px; }
.growth-up { color: #7EC850; }
.growth-down { color: #E55555; }
.growth-label { color: #7F8C8D; font-size: 12px; }
