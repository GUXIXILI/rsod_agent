    ...
    <el-card v-if="evalReport" class="eval-card" shadow="never">
      ...
      >
        ...
        <el-table-column prop="ap50" label="AP@50" width="120">
          <template #default="{ row }">
            <span :style="{ color: row.ap50 < 0.5 ? '#4A90D9' : '#87CEEB' }">
      ...
      <el-form :model="trainForm" label-width="120px">
        ...
        <el-form-item label="训练设备">
          <el-radio-group v-model="trainForm.device">
            <el-radio label="cpu" value="cpu">CPU (本地)</el-radio>
            <el-radio label="0" value="0">GPU:0</el-radio>
            <el-radio label="1" value="1">GPU:1</el-radio>
          </el-radio-group>
        </el-form-item>
    ...
    mapChart.setOption({
      ...
      series: [
        ...
        },
        {
          ...
          smooth: true,
          lineStyle: { width: 2, type: "dashed", color: "#4A90D9" },
          itemStyle: { color: "#4A90D9" },
        },
        {
          name: "Recall",
          ...
          smooth: true,
          lineStyle: { width: 2, type: "dashed", color: "#87CEEB" },
          itemStyle: { color: "#87CEEB" },
        },
      ],
    });
  ...
  return [
    {
      ...
      color: o.precision > 0.7 ? "#87CEEB" : "#4A90D9",
    },
    {
      label: "Recall",
      value: (o.recall * 100).toFixed(1) + "%",
      color: o.recall > 0.7 ? "#87CEEB" : "#4A90D9",
    },
    {
      label: "mAP@50",
      value: (o.map50 * 100).toFixed(1) + "%",
      color: o.map50 > 0.5 ? "#87CEEB" : "#4A90D9",
    },
    {
      label: "mAP@50-95",
      value: (o.map50_95 * 100).toFixed(1) + "%",
      color: o.map50_95 > 0.3 ? "#87CEEB" : "#4A90D9",
    },
  ];
});
...
:deep(.el-button--primary) {
  ...
  --el-button-hover-bg-color: #3A7BC8;
  --el-button-hover-border-color: #3A7BC8;
}
